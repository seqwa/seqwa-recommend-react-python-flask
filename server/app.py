...
def recommend():
    """Seqwa Recommend API"""
    response = requests.get('https://www.seqwa.com/api/v1/recommend', params={
        "index": 'cde1d8e5-f0af-4498-801d-3ff82acec9c6', # Replace with your Index Id
        "context": request.args.get('context'), # In case of find recommendations for recordId make sure that you send an empty string. Since 'undefined' or 'null' will be converted into string
        "recordId": request.args.get('recordId'), 
        "fields": 'title,price,image,link',
        "maxResults": 25,
    }, headers={'Content-Type': 'application/json', 'seqwa-api-key': 'e77a4fc42c20aab5827b61162be3a8dd779b1d1a'})
